...
var _algorithmMinimax_alphaBetaPruning = require('./algorithm/minimax_alpha-beta-pruning');

var minimaxAlphaBetaPruning = _interopRequireWildcard(_algorithmMinimax_alphaBetaPruning);

var MOVES = ['u', 'r', 'd', 'l'];

var countTime = function countTime(func) {
...
var Game2048Player = (function (_Component) {
        ...
        this.toggleAutoPlay = function () {
            ...
            var calculateAndPlay = function calculateAndPlay() {
                if (_this.state.autoPlayOn) {
                    var nextMove = _this.calculateNextMove({
                    ...
                    if (nextMove) {
                        _this.props.game2048.move(nextMove);
    ...
    _createClass(Game2048Player, [{
        ...
        value: function calculateNextMove(_ref2) {
            ...
            var result = _countTime.result;
            var time = _countTime.time;
